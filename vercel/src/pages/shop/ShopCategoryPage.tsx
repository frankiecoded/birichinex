      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5">
          <button
            ...
            className={`h-8 w-8 rounded-[8px] flex items-center justify-center transition-all ${view === "grid" ? "bg-emphasis text-on-emphasis shadow-[0_1px_3px_rgba(0,0,0,0.2)]" : "bg-surface-secondary/80 text-ink-secondary hover:bg-surface-secondary"}`}
          >
            <Grid3X3 className="h-3.5 w-3.5" strokeWidth={1.5} />
          </button>
          <button
            onClick={() => setView("list")}
            className={`h-8 w-8 rounded-[8px] flex items-center justify-center transition-all ${view === "list" ? "bg-emphasis text-on-emphasis shadow-[0_1px_3px_rgba(0,0,0,0.2)]" : "bg-surface-secondary/80 text-ink-secondary hover:bg-surface-secondary"}`}
          >

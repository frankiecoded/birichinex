...
export const SEED_TRACKED_SHIPMENTS: TrackedShipment[] = [
  {
    id: 'sh-001', kind: 'shipment', title: 'Men Cotton Shirts — 20 bales wholesale', weight: 245, weightUnit: 'kg', totalAmount: 850000, currency: 'TZS', status: 'delivered',
    originCity: 'Dar es Salaam', originCountry: 'Tanzania', destinationCity: 'Nairobi', destinationCountry: 'Kenya',
    originLat: -6.7924, originLng: 39.2083, destinationLat: -1.2864, destinationLng: 36.8172, currentLat: -1.2864, currentLng: 36.8172,
    trackingNumber: 'PM-TRK-20260701-001', carrier: 'DHL Express', createdAt: '2026-06-25T08:00:00Z', estimatedDelivery: '2026-07-01T18:00:00Z', deliveredAt: '2026-07-01T14:00:00Z',
    events: [
      { status: 'placed', timestamp: '2026-06-25T08:00:00Z', location: 'Dar es Salaam HQ', lat: -6.7924, lng: 39.2083, note: 'Shipment created and awaiting pickup' },
      { status: 'picked_up', timestamp: '2026-06-26T09:00:00Z', location: 'Dar es Salaam Warehouse', lat: -6.77, lng: 39.25, note: 'Collected by DHL Express driver' },
      { status: 'in_transit', timestamp: '2026-06-27T07:00:00Z', location: 'Dar es Salaam Port', lat: -6.7, lng: 39.18, note: 'Departed origin country' },
      { status: 'out_for_delivery', timestamp: '2026-06-30T10:00:00Z', location: 'Nairobi Distribution Hub', lat: -1.26, lng: 36.88, note: 'Package on delivery vehicle' },
      { status: 'delivered', timestamp: '2026-07-01T14:00:00Z', location: 'Nairobi CBD', lat: -1.2864, lng: 36.8172, note: 'Delivered — signed by J. Mwangi' },
    ],
    consignee: 'Jabali Enterprises', contactPhone: '+254722345678', type: 'export', customsStatus: 'cleared', customsDocumentRef: 'EXP-2026-TZ-00412',
  },
  {
    id: 'sh-002', kind: 'shipment', title: 'Leather Jackets & Sportswear — 30 bales', weight: 1200, weightUnit: 'kg', totalAmount: 4500000, currency: 'TZS', status: 'in_transit',
    originCity: 'Milan', originCountry: 'Italy', destinationCity: 'Dar es Salaam', destinationCountry: 'Tanzania',
    originLat: 45.4642, originLng: 9.19, destinationLat: -6.7924, destinationLng: 39.2083, currentLat: 25.2048, currentLng: 55.2708,
    trackingNumber: 'PM-TRK-20260705-002', carrier: 'FedEx International', createdAt: '2026-06-22T08:00:00Z', estimatedDelivery: '2026-07-09T18:00:00Z',
    events: [
      { status: 'placed', timestamp: '2026-06-22T08:00:00Z', location: 'Milan Warehouse', lat: 45.4642, lng: 9.19, note: 'Order confirmed and packed' },
      { status: 'picked_up', timestamp: '2026-06-23T07:00:00Z', location: 'Milan FedEx Hub', lat: 45.5, lng: 9.2, note: 'Package collected' },
      { status: 'in_transit', timestamp: '2026-06-26T12:00:00Z', location: 'Dubai Transit Hub', lat: 25.2048, lng: 55.2708, note: 'In transit via Dubai' },
    ],
    consignee: 'Portmetals Africa Trading', contactPhone: '+255752001234', type: 'import', customsStatus: 'processing', customsDocumentRef: 'IMP-2026-TZ-00891',
  },
  {
    id: 'sh-003', kind: 'shipment', title: 'MacBook Air M2 units — Tech export', weight: 85, weightUnit: 'kg', totalAmount: 1200000, currency: 'TZS', status: 'picked_up',
    originCity: 'Dar es Salaam', originCountry: 'Tanzania', destinationCity: 'Lagos', destinationCountry: 'Nigeria',
    originLat: -6.7924, originLng: 39.2083, destinationLat: 6.5244, destinationLng: 3.3792, currentLat: -6.77, currentLng: 39.25,
    trackingNumber: 'PM-TRK-20260708-003', carrier: 'UPS Worldwide', createdAt: '2026-07-06T09:00:00Z', estimatedDelivery: '2026-07-16T18:00:00Z',
    events: [
      { status: 'placed', timestamp: '2026-07-06T09:00:00Z', location: 'Dar es Salaam Tech Hub', lat: -6.7924, lng: 39.2083, note: 'Shipment registered' },
      { status: 'picked_up', timestamp: '2026-07-07T10:00:00Z', location: 'Dar es Salaam Warehouse', lat: -6.77, lng: 39.25, note: 'Collected by UPS driver' },
    ],
    consignee: 'TechBridge Nigeria Ltd', contactPhone: '+2348012345678', type: 'export', customsStatus: 'cleared', customsDocumentRef: 'EXP-2026-TZ-00428',
  },
  {
    id: 'sh-004', kind: 'shipment', title: 'Refurbished iPhone 14 Pro — 15 units', weight: 320, weightUnit: 'kg', totalAmount: 2800000, currency: 'TZS', status: 'out_for_delivery',
    originCity: 'Amsterdam', originCountry: 'Netherlands', destinationCity: 'Dar es Salaam', destinationCountry: 'Tanzania',
    originLat: 52.3676, originLng: 4.9041, destinationLat: -6.7924, destinationLng: 39.2083, currentLat: -6.81, currentLng: 39.27,
    trackingNumber: 'PM-TRK-20260712-004', carrier: 'DHL Express', createdAt: '2026-07-07T08:00:00Z', estimatedDelivery: '2026-07-13T18:00:00Z',
    events: [
      { status: 'placed', timestamp: '2026-07-07T08:00:00Z', location: 'Amsterdam Warehouse', lat: 52.3676, lng: 4.9041, note: 'Package prepared' },
      { status: 'picked_up', timestamp: '2026-07-08T09:00:00Z', location: 'Amsterdam DHL Hub', lat: 52.4, lng: 4.9, note: 'Collected for international shipping' },
      { status: 'in_transit', timestamp: '2026-07-09T11:00:00Z', location: 'Addis Ababa Transit', lat: 8.9806, lng: 38.7578, note: 'Via Ethiopian Airlines cargo' },
      { status: 'out_for_delivery', timestamp: '2026-07-12T08:00:00Z', location: 'Dar es Salaam Distribution', lat: -6.81, lng: 39.27, note: 'Out for final delivery' },
    ],
    consignee: 'Zawadi Mobiles', contactPhone: '+255754321098', type: 'import', customsStatus: 'cleared', customsDocumentRef: 'IMP-2026-TZ-00902',
  },
  {
    id: 'sh-005', kind: 'shipment', title: 'Ladies Handbags — Small batch retail', weight: 45, weightUnit: 'kg', totalAmount: 350000, currency: 'TZS', status: 'placed',
    originCity: 'Dar es Salaam', originCountry: 'Tanzania', destinationCity: 'Kampala', destinationCountry: 'Uganda',
    originLat: -6.7924, originLng: 39.2083, destinationLat: 0.3476, destinationLng: 32.5825, currentLat: -6.7924, currentLng: 39.2083,
    trackingNumber: 'PM-TRK-20260715-005', carrier: 'Tanzania Post', createdAt: '2026-07-14T08:00:00Z', estimatedDelivery: '2026-07-21T18:00:00Z',
    events: [
      { status: 'placed', timestamp: '2026-07-14T08:00:00Z', location: 'Dar es Salaam HQ', lat: -6.7924, lng: 39.2083, note: 'Awaiting customs clearance and pickup' },
    ],
    consignee: 'Grace Upholstery & Fashion', contactPhone: '+256772345678', type: 'export', customsStatus: 'pending', customsDocumentRef: 'EXP-2026-TZ-00435',
  },
  {
    id: 'sh-006', kind: 'shipment', title: 'USB-C Hubs & Chargers — Container shipment', weight: 5000, weightUnit: 'kg', totalAmount: 12000000, currency: 'TZS', status: 'in_transit',
    originCity: 'Guangzhou', originCountry: 'China', destinationCity: 'Dar es Salaam', destinationCountry: 'Tanzania',
    originLat: 23.1291, originLng: 113.2644, destinationLat: -6.7924, destinationLng: 39.2083, currentLat: -3.0, currentLng: 44.0,
    trackingNumber: 'PM-TRK-20260718-006', carrier: 'Maersk Line', createdAt: '2026-06-20T08:00:00Z', estimatedDelivery: '2026-08-05T18:00:00Z',
    events: [
      { status: 'placed', timestamp: '2026-06-20T08:00:00Z', location: 'Guangzhou Factory', lat: 23.1291, lng: 113.2644, note: 'Order packed into container' },
      { status: 'picked_up', timestamp: '2026-06-21T09:00:00Z', location: 'Shenzhen Port', lat: 22.5431, lng: 114.0579, note: 'Container loaded on vessel' },
      { status: 'in_transit', timestamp: '2026-06-24T12:00:00Z', location: 'Indian Ocean', lat: -3.0, lng: 44.0, note: 'En route to Dar es Salaam Port' },
    ],
    consignee: 'Simba Tech Imports', contactPhone: '+255755678901', type: 'import', customsStatus: 'processing', customsDocumentRef: 'IMP-2026-TZ-00910',
  },
];

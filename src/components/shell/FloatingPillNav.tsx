          ...
          >
            <div className="relative">
              ...
              <div className="relative flex items-center gap-3 h-[54px] px-6 rounded-full
                bg-white/70 backdrop-blur-2xl saturate-150 brightness-110
              ...
              >
                <div className="h-9 w-9 rounded-[10px] bg-ink flex items-center justify-center shrink-0 relative overflow-hidden shadow-[0_1px_3px_rgba(0,0,0,0.2)]">
        ...
        {expanded && (
          <>
            <motion.div
              ...
              className="fixed inset-0 bg-ink/10 backdrop-blur-sm z-[998]"
            ...
            >
              <div className="
                rounded-[28px]
                bg-white/65 backdrop-blur-3xl saturate-[180%] brightness-[1.08]
              ...
              ">
                <div className="flex items-center gap-4 px-6 pt-5 pb-4">
                  <button onClick={() => handleNavigate("home")} className="flex items-center gap-2.5 shrink-0 group">
                    <div className="h-10 w-10 rounded-[11px] bg-ink flex items-center justify-center group-hover:scale-105 transition-transform relative overflow-hidden shadow-[0_1px_4px_rgba(0,0,0,0.2)]">
                      <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent" />
                  ...
                  <div className={`flex-1 flex items-center gap-2.5 h-12 px-4 rounded-[14px] border transition-all duration-300 ${
                    searchFocused
                      ? "bg-white/80 border-brand/25 shadow-[0_0_0_3px_rgba(212,175,55,0.08),0_2px_8px_rgba(0,0,0,0.04)]"
                  ...
                  <button
                    onClick={() => { setExpanded(false); setActiveCategory(null); }}
                    className="h-12 w-12 rounded-[14px] bg-white/40 border border-white/40 flex items-center justify-center text-ink-secondary hover:text-ink hover:bg-white/60 transition-all duration-200 shrink-0"
                  >
                    <X className="h-5 w-5" />
                  </button>
                </div>

                <div className="mx-5 h-[1px] bg-gradient-to-r from-transparent via-black/[0.06] to-transparent" />
                ...
                <div className="flex items-center justify-between gap-3 px-6 pt-4 pb-5">
                  <div className="flex items-center gap-1 bg-white/40 p-1 rounded-[12px] border border-white/40">
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-[9px] text-[11px] font-bold tracking-wider transition-all duration-200 ${
                          selectedCurrency === curr
                            ...
                            : "text-ink-tertiary hover:text-ink hover:bg-white/50"
                        }`}
                      >
                        {curr}
                      </button>
                  ...
                  <div className="flex items-center gap-2">
                    <button className="h-11 w-11 rounded-[12px] bg-white/40 border border-white/40 flex items-center justify-center text-ink-secondary hover:text-ink hover:bg-white/60 transition-all duration-200">
                      <Heart className="h-[18px] w-[18px]" strokeWidth={1.5} />
                    </button>
                    <button
                      onClick={() => handleNavigate("account")}
                      className="relative h-11 w-11 rounded-[12px] bg-ink flex items-center justify-center text-white text-subhead font-bold hover:bg-ink/90 transition-colors overflow-hidden shadow-[0_1px_4px_rgba(0,0,0,0.2)]"
                    >
                      <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent" />
          ...
          <>
            ...
            <motion.div
              ...
              className="fixed z-[1001] w-60 rounded-[20px]
                bg-white/80 backdrop-blur-3xl saturate-[180%]
                border border-white/50
            ...
            >
              {SHOP_CATEGORIES.find(c => c.id === activeCategory)?.subcategories.map((sub, i) => (
                <motion.button
                  ...
                  className="w-full text-left px-3.5 py-2.5 rounded-[12px] text-[15px] text-ink-secondary hover:bg-white/60 hover:text-ink transition-all duration-150 group flex items-center justify-between"
                >
                  {sub}
                  <ArrowRight className="h-3.5 w-3.5 opacity-0 group-hover:opacity-100 transition-opacity" />
                </motion.button>
              ))}
              <div className="mx-1 my-1 h-[1px] bg-gradient-to-r from-transparent via-black/[0.06] to-transparent" />
              <button

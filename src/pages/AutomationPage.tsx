    ...
    <div className="p-6 lg:p-8 max-w-7xl mx-auto space-y-8 relative">
      ...
      <AnimatePresence>
        {workflowModal && (
          ...
          >
            <div className="absolute inset-0 bg-ink/40 backdrop-blur-sm" onClick={() => setWorkflowModal(null)} />
            <motion.div
      ...
      <AnimatePresence>
        {triggerModal && (
          <motion.div
            ...
            className="fixed inset-0 z-50 flex items-center justify-center p-4"
          >
            <div className="absolute inset-0 bg-ink/40 backdrop-blur-sm" onClick={() => setTriggerModal(null)} />
            <motion.div
              initial={{ opacity: 0, scale: 0.95, y: 8 }}
              animate={{ opacity: 1, scale: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.95, y: 8 }}
      ...
      <AnimatePresence>
        {notifModal && (
          <motion.div
            ...
            className="fixed inset-0 z-50 flex items-center justify-center p-4"
          >
            <div className="absolute inset-0 bg-ink/40 backdrop-blur-sm" onClick={() => setNotifModal(null)} />
            <motion.div
              initial={{ opacity: 0, scale: 0.95, y: 8 }}
              animate={{ opacity: 1, scale: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.95, y: 8 }}
      ...
      <AnimatePresence>
        {ruleModal && (
          <motion.div
            ...
            className="fixed inset-0 z-50 flex items-center justify-center p-4"
          >
            <div className="absolute inset-0 bg-ink/40 backdrop-blur-sm" onClick={() => setRuleModal(null)} />
            <motion.div
              initial={{ opacity: 0, scale: 0.95, y: 8 }}
              animate={{ opacity: 1, scale: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.95, y: 8 }}

...
export default function ShopAccountPage({ selectedCurrency, onNavigate }: ShopAccountPageProps) {
  ...
  const inputClass =
    "w-full h-11 px-4 rounded-[12px] bg-white/60 border border-black/[0.06] text-ink text-[15px] placeholder:text-ink-quaternary focus:outline-none focus:ring-2 focus:ring-brand/30 focus:border-brand/40 transition-all";
    ...
    <div className="min-h-screen pb-32">
      ...
      <div className="px-5 max-w-2xl mx-auto space-y-5 -mt-1">
              ...
              <div className="relative">
                ...
                <div className="grid grid-cols-3 gap-2 mt-4">
                  {[
                    ...
                    <div key={stat.label} className="text-center p-2 rounded-[10px] bg-white/50 border border-black/[0.03]">
        ...
        <motion.div
          ...
          className="rounded-[18px] bg-white/70 backdrop-blur-xl border border-black/[0.04] overflow-hidden"
        >
        ...
        >
          {[
            ...
            <button
              ...
              className={`relative overflow-hidden rounded-[16px] bg-gradient-to-br ${action.color} border border-black/[0.03] p-4 text-left hover:scale-[1.01] active:scale-[0.99] transition-transform`}
            >
        ...
        {redeemOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-x-4 top-1/2 -translate-y-1/2 max-w-sm mx-auto z-50 rounded-[24px] bg-white/90 backdrop-blur-3xl border border-white/60 shadow-[0_24px_80px_rgba(0,0,0,0.2)] p-6"
            >

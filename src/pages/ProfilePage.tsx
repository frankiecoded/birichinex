...
const SESSIONS = [
  { id: "1", device: "MacBook Pro — Chrome", location: "Dar es Salaam, Tanzania", lastActive: "Now", current: true },
  { id: "2", device: "iPhone 15 Pro — Safari", location: "Dar es Salaam, Tanzania", lastActive: "3 hours ago", current: false },
  { id: "3", device: "iPad Air — Safari", location: "Nairobi, Kenya", lastActive: "2 days ago", current: false },
];
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[13px] text-ink-tertiary">{session.location} · {session.lastActive}</p>
                      </div>
                    </div>
                    {session.current ? (

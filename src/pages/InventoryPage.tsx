...
import { Package, Search, Filter, Plus, ArrowUpRight, ArrowDownRight, Trash2, X, Store, ShoppingBag, Globe } from "lucide-react";
      ...
      <AnimatePresence>
        {postModalItem && (
          <motion.div
            ...
            className="fixed inset-0 z-50 flex items-center justify-center p-4"
          >
            <div className="absolute inset-0 bg-ink/40 backdrop-blur-sm" onClick={() => setPostModalItem(null)} />
            <motion.div
              initial={{ opacity: 0, scale: 0.95, y: 8 }}
              animate={{ opacity: 1, scale: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.95, y: 8 }}

  ...
  return (
    <div className="p-6 lg:p-8 max-w-7xl mx-auto space-y-8">
          ...
          {MENTORS.map((mentor, i) => (
            ...
            >
              <GlassCard padding="md" hover className="text-center">
                <div className="h-14 w-14 rounded-full bg-ink mx-auto mb-3 flex items-center justify-center">
      ...
      <AnimatePresence>
        {selectedOpportunity && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="absolute inset-0 bg-ink/40 backdrop-blur-md" onClick={() => setSelectedOpportunity(null)} />
            <motion.div
      ...
      <AnimatePresence>
        {connectingMentor && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="absolute inset-0 bg-ink/40 backdrop-blur-md" onClick={() => { if (!connectSent) { setConnectingMentor(null); setConnectMessage(""); } }} />
            <motion.div
              initial={{ opacity: 0, scale: 0.95, y: 12 }}
              animate={{ opacity: 1, scale: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.95, y: 12 }}
